...
*/
    ...
    BigUInt op11("198765432198765432198765432123456789123456789123456789123456789123456789"),op21("987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321987654321");

    BigUInt sum; 
    sum = op21 - op11;

    cout << op21.ToString() << " - " << op11.ToString() << " = " << sum.ToString() << endl;
